gcc -o ../objects/bool.o -c ../src/bool.c
gcc ../test/testbool.c ../objects/bool.o 
gcc -o ../objects/bool.o -c ../src/bool.c
gcc ../test/testbool.c ../objects/bool.o 
gcc -o ../objects/bool.o -c ../src/bool.c
gcc ../test/testbool.c ../objects/bool.o 
...
C_INCLUDE_PATH=$SCRIPT_DIR/../include/:$C_INCLUDE_PATH
gcc -Wall -c $SCRIPT_DIR/../src/bool.c -o $SCRIPT_DIR/../objects/bool.o
gcc -Wall -c $SCRIPT_DIR/../test/testbool.c -o $SCRIPT_DIR/../objects/testbool.o
gcc -Wall $SCRIPT_DIR/../objects/*.o -o $SCRIPT_DIR/../bin/a.out
#!/bin/bash
